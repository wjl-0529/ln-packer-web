...
import 'package:ln_packer_web/light_novel/wenku_novel/wenku_novel.dart';
...
import 'package:ln_packer_web/util/url_util.dart';
...
class WenkuNovelSource implements LightNovelSource {
  ...
  WenkuNovelSource({this.runContext}) {
    _scheduler = runContext?.createScheduler(
          _envInt(
            "PACKER_WENKU_REQUESTS_PER_MINUTE",
            _rateMode == "fast" ? 40 : 20,
          ),
          Duration(minutes: 1),
        ) ??
        Scheduler(
