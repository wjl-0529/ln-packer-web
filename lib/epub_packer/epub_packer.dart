...
import 'package:ln_packer_web/epub_packer/epub_constant.dart';
import 'package:ln_packer_web/epub_packer/epub_navigator.dart';
import 'package:ln_packer_web/epub_packer/epub_opf.dart';
import 'package:ln_packer_web/media_type.dart' as epub_media_type;
import 'package:ln_packer_web/media_type.dart';
...
class EpubPacker {
  ...
  /// 执行打包操作
  void pack() {
    File(epubFilePath).parent.createSync(recursive: true);
    bookUuid = Uuid().v1();
